...
--
-- Хост: 127.0.0.1
-- Время создания: Авг 11 2019 г., 13:33
...
--
-- База данных: `dataadminapi`
--
CREATE DATABASE `dataadminapi` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `dataadminapi`;

-- --------------------------------------------------------

--
-- Структура таблицы `data_authorizationadmin`
--

CREATE TABLE IF NOT EXISTS `data_authorizationadmin` (
  `id` varchar(16) CHARACTER SET utf8 NOT NULL,
  `login` varchar(20) CHARACTER SET utf8 NOT NULL,
  `password` varchar(32) CHARACTER SET utf8 NOT NULL,
  `token` varchar(32) CHARACTER SET utf32 NOT NULL,
...
--
-- Дамп данных таблицы `data_authorizationadmin`
--

INSERT INTO `data_authorizationadmin` (`id`, `login`, `password`, `token`, `mail`, `name`) VALUES
('black_horse', 'kaidor', '1234567890', 'admin1_token_id78633', 'admin.mail@mail.ru', 'admin_black_horse ');
...
CREATE TABLE IF NOT EXISTS `data_comments` (
  `id_comment` int(16) NOT NULL AUTO_INCREMENT,
  `id_user` int(32) DEFAULT NULL,
  `id_story` varchar(64) NOT NULL,
  `name_user` varchar(32) DEFAULT NULL,
  `text_comment` varchar(2048) NOT NULL,
  `date_comment` varchar(32) NOT NULL,
  PRIMARY KEY (`id_comment`),
  KEY `name_user` (`name_user`),
  KEY `name_user_2` (`name_user`),
  KEY `name_user_3` (`name_user`),
  KEY `id_user` (`id_user`),
  KEY `id_story` (`id_story`),
  KEY `id_story_2` (`id_story`)
...
INSERT INTO `data_comments` (`id_comment`, `id_user`, `id_story`, `name_user`, `text_comment`, `date_comment`) VALUES
(2, 1, 'TihookeanskiyRubeg_story', 'Ruslan', 'My name is Ruslan!', '2019/February/17 17:46:34');

-- --------------------------------------------------------

--
-- Структура таблицы `data_comments_administrator`
--

CREATE TABLE IF NOT EXISTS `data_comments_administrator` (
  ...
  KEY `id_story` (`id_story`),
  KEY `name_admin` (`name_admin`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4 ;

--
-- Дамп данных таблицы `data_comments_administrator`
--

INSERT INTO `data_comments_administrator` (`id_comment`, `id_admin`, `id_story`, `name_admin`, `text_comment`, `date_comment`) VALUES
(1, 'black_horse ', 'TihookeanskiyRubeg_story', 'admin_black_horse ', 'Я вижу все!', '2019/February/21 13:01:59'),
(3, 'black_horse ', 'TihookeanskiyRubeg_story', 'admin_black_horse ', 'тестовое_админ', '2019/July/05 20:34:36');

-- --------------------------------------------------------

--
-- Структура таблицы `data_stories`
--

CREATE TABLE IF NOT EXISTS `data_stories` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `story_title` varchar(64) CHARACTER SET utf8 NOT NULL,
  `story_anons` varchar(32) CHARACTER SET utf8 NOT NULL,
  `story_text` varchar(2048) CHARACTER SET utf8 NOT NULL,
  `story_image` varchar(256) CHARACTER SET utf8 NOT NULL,
  `story_date_creation` varchar(32) CHARACTER SET utf8 NOT NULL,
  `story_date_eddition` varchar(32) COLLATE utf8_bin NOT NULL,
  `story_link` varchar(64) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Дамп данных таблицы `data_stories`
--

INSERT INTO `data_stories` (`story_id`, `story_title`, `story_anons`, `story_text`, `story_image`, `story_date_creation`, `story_date_eddition`, `story_link`) VALUES
('Akira_story', 'Акира', '1988 г.', 'Спустя 30 лет после Третьей мировой войны, когда была ядерная бомбардировка Японии был создан новый город - Нью Токио. Именно этот город стал новой столицей Японии. Не смотря на то, что война уже давно прошла, но накал все таки остался. Визуально нет никакой опасности, но руководство страны держит все под своим жестким контролем. Страна теперь напоминает фашистское государство, которые всячески подавляют любые попытки захватить власть. Жесткие наказания, расстрелы, а также другие методы борьбы с партизанами применяются на территории всей Японии. В специализированных центрах над людьми проводят жесткие эксперименты, которые посвящены контролю над человеческим разумом. Власти всячески пытаются разработать оружие массового поражения. Наиболее значимой фигурой данных экспериментов является полковник Сикисима, который является руководителем большого проекта. Однако его самостоятельность приводит к вражде с высшим руководством страны. Формируется новый лик человека, который может все. Это сверхчеловек Акира, с помощью которого можно будет решить все проблемы. К чему приведет такой целостный контроль над всеми сфера человеческой жизнедеятельности?', '../uploads/256785.jpg', '2019/July/25 14:39:26', '2019/July/25 14:41:50', 'pagesStories/Akira_story.php'),
('One_Pice_story', 'One Pice', '1999 г.', 'Монки Д. Луффи в аниме сериале Ван-Пис - резиновый человек, как так подумают многие, это все случилось еще в детстве, когда он съел неизвестный фрукт после чего он и приобрел эту способность. Он с детства мечтал стать пиратом и отыскать сокровище которое как все думают оставил после своей смерти самый могущий и величающий пират которого только видело море, Золотой Роджер. В аниме сериале Ван Пис рассказывается о невероятных приключениях Манки. В каждой новой серии молодого и отважного Манки ждут новые преграды к его давней цели найти все таки этот клад. Удастся ли ему это или он со своей командой будет потоплен в беспощадной черной воде океана, через что ему предстоит пройти для этого, все это и много другое вы узнаете посмотрев все серии сериала ван пис на нашем сайте\r\n', '../uploads/s1200.jpg', '2019/July/25 18:54:44', '2019/July/25 19:06:03', 'pagesStories/One_Pice_story.php'),
('Overlord_story', 'Overlord', '2015 г.', 'Аниме сериал «Владыка» — это история об игровой реальности. Многие люди, не взирая на возраст и род деятельности плотно «подсаживаются» на онлайн-игры, проводят там много времени и проживают выбранным персонажем целую жизнь. Так было и с игрой «Иггдрасиль» отличная графика, продуманный до мелочей сюжет, точнейшая детализация все это сделало игру популярной, а некий Момонг создал в ней сильнейшую гильдию, названную «Эйнз Оул Гаун», вступить туда было практически невозможно потому, что все там было на высшем уровне. Несерьезных детей и подростков, как членов гильдии даже не рассматривали как кандидатов, за их непостоянность и несерьезность. Все, кто принадлежал к их рядам были совершеннолетние имеющие работу и соответственно серьезное отношение к игре, люди. Но не даром говорят, что все в этом мире конечно, закончилась и эта золотая пора, создатели предложили кое-что поновее и по интереснее, сообщили что этот проект будет свернут. «Эйнз Оул Гаун» пришлось распустить и только лидер клана Момонга оставался там до самого конца ожидая с замиранием сердца отключения серверов. Какого же было его удивление, когда после того как было все отключено он просто оказался в игровой реальности, в мире «Иггдрасиль».', '../uploads/overlord.jpg', '2019/July/25 14:22:07', '2019/July/25 14:35:00', 'pagesStories/Overlord_story.php'),
('TihookeanskiyRubeg_story', 'Тихоокеанский Рубеж', '11 июля 2013 г.', 'Когда из морских глубин поднялись легионы чудовищ, известных как кайдзю, началась война, которой суждено было забрать миллионы жизней и свести «человеческие ресурсы» почти к нулю всего за несколько лет. Чтобы сражаться с пришельцами, было создано специальное оружие: огромные роботы, названные егерями, они управлялись одновременно двумя пилотами, чьи сознания соединены с помощью нейронной связи. Но даже егеря оказываются почти бессильны перед лицом безжалостных кайдзю. На грани поражения у защитников человечества нет выбора, кроме как обратиться к двум весьма сомнительным героям — никому не нужному бывшему пилоту и неопытному стажеру — которые объединились, чтобы повести в бой некогда легендарного, но сейчас устаревшего егеря. Вместе они оказываются единственной надеждой человечества, последним препятствием перед надвигающимся апокалипсисом.', '../uploads/iphone360_546915.png', '2019/February/09 15:34:46', '2019/July/23 18:40:59', 'pagesStories/TihookeanskiyRubeg_story.php'),
('TokiyskiyGuli_story', 'Токийский Гуль', '2014 г.', 'Главный герой аниме сериала «Токийский гуль» простой паренек по имени Канеки Кен, у него есть серьезное увлечение, он любит читать, есть настоящий друг, с которым он часто проводит время. Но девушки у него не было, да и не каждая бы ему пришлась по вкусу. Но тут он увидел ее, она держала в руках книги, была мила и Канеки предложил ей свою помощь. Неся в своей юной голове всякий романтичный бред, он еще не знал, что он вполне, в ее вкусе, как и любой другой человек, ведь единственное чего девушка хотела от него это полакомиться его свеженьким мясом. Такая у нее гуля сущность. Уже простившись с жизнью паренек даже подумать не мог, что волею судьбы он окажется таким же монстром как та что пыталась его сожрать.', '../uploads/972d85f73dfb75556a342c1c9a014eaa5dd3c46fr1-644-856v2_hq.jpg', '2019/July/25 14:45:44', '2019/July/25 14:48:08', 'pagesStories/TokiyskiyGuli_story.php');
...
CREATE TABLE IF NOT EXISTS `data_users` (
  ...
  `date_regist` varchar(32) NOT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `data_users` (`user_id`, `user_name`, `user_mail`, `date_regist`) VALUES
(1, 'Ruslan', 'rusik1.rusik1@mail.ru', '2019/February/17 16:53'),
(2, 'Джон', 'jonMail@mail.ru', '2019/February/21 12:02:03'),
(3, 'Ира', 'iren12101@mail.ru', '2019/June/26 19:34:08');

-- --------------------------------------------------------

--
-- Структура таблицы `tags_akira_story`
--

CREATE TABLE IF NOT EXISTS `tags_akira_story` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `tag_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`,`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

--
-- Дамп данных таблицы `tags_akira_story`
--

INSERT INTO `tags_akira_story` (`story_id`, `tag_id`) VALUES
('Akira_story', '#akira'),
('Akira_story', '#anime'),
('Akira_story', '#акира'),
('Akira_story', '#аниме');
...
--
-- Структура таблицы `tags_one_pice_story`
--

CREATE TABLE IF NOT EXISTS `tags_one_pice_story` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `tag_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`,`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Дамп данных таблицы `tags_one_pice_story`
--

INSERT INTO `tags_one_pice_story` (`story_id`, `tag_id`) VALUES
('One_Pice_story', '#anime'),
('One_Pice_story', '#one_pice'),
('One_Pice_story', '#аниме'),
('One_Pice_story', '#ван_пис');

-- --------------------------------------------------------

--
-- Структура таблицы `tags_overlord_story`
--

CREATE TABLE IF NOT EXISTS `tags_overlord_story` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `tag_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`,`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Дамп данных таблицы `tags_overlord_story`
--

INSERT INTO `tags_overlord_story` (`story_id`, `tag_id`) VALUES
('Overlord_story', '#anime'),
('Overlord_story', '#overlord'),
('Overlord_story', '#аниме'),
('Overlord_story', '#владыка'),
('Overlord_story', '#оверлорд'),
('Overlord_story', '#повелитель');

-- --------------------------------------------------------

--
-- Структура таблицы `tags_tihookeanskiyrubeg_story`
--

CREATE TABLE IF NOT EXISTS `tags_tihookeanskiyrubeg_story` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `tag_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`,`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Дамп данных таблицы `tags_tihookeanskiyrubeg_story`
--

INSERT INTO `tags_tihookeanskiyrubeg_story` (`story_id`, `tag_id`) VALUES
('TihookeanskiyRubeg_story', '#evangelion_2.0'),
('TihookeanskiyRubeg_story', '#pacific_rim'),
('TihookeanskiyRubeg_story', '#боевик'),
('TihookeanskiyRubeg_story', '#плагиат_евангилиона'),
('TihookeanskiyRubeg_story', '#тихоокеанский_рубеж');

-- --------------------------------------------------------

--
-- Структура таблицы `tags_tokiyskiyguli_story`
--

CREATE TABLE IF NOT EXISTS `tags_tokiyskiyguli_story` (
  `story_id` varchar(64) CHARACTER SET utf8 NOT NULL,
  `tag_id` varchar(128) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`story_id`,`tag_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Дамп данных таблицы `tags_tokiyskiyguli_story`
--

INSERT INTO `tags_tokiyskiyguli_story` (`story_id`, `tag_id`) VALUES
('TokiyskiyGuli_story', '#anime'),
('TokiyskiyGuli_story', '#tokyo_ghoul'),
('TokiyskiyGuli_story', '#аниме'),
('TokiyskiyGuli_story', '#токийский_гуль');
--
...
('def', 'dataadminapi', 'data_authorizationadmin', 'id', 1, NULL, 'NO', 'varchar', 16, 48, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(16)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'login', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'password', 3, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'token', 4, NULL, 'NO', 'varchar', 32, 128, NULL, NULL, 'utf32', 'utf32_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'mail', 5, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'name', 6, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'id_comment', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(16)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'id_user', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'id_story', 3, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'name_user', 4, NULL, 'YES', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'text_comment', 5, NULL, 'NO', 'varchar', 2048, 6144, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2048)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments', 'date_comment', 6, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'id_comment', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(32)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'id_admin', 2, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'id_story', 3, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'name_admin', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'text_comment', 5, NULL, 'NO', 'varchar', 2048, 6144, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2048)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'date_comment', 6, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_title', 2, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_anons', 3, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_text', 4, NULL, 'NO', 'varchar', 2048, 6144, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2048)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_image', 5, NULL, 'NO', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_date_creation', 6, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_date_eddition', 7, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_bin', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_stories', 'story_link', 8, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_users', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(32)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_users', 'user_name', 2, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_users', 'user_mail', 3, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'data_users', 'date_regist', 4, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', '', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_akira_story', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_akira_story', 'tag_id', 2, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_one_pice_story', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_one_pice_story', 'tag_id', 2, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_overlord_story', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_overlord_story', 'tag_id', 2, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'tag_id', 2, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'story_id', 1, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'tag_id', 2, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', 'PRI', '', 'select,insert,update,references', ''),
...
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '1737'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '1603'),
('INNODB_BUFFER_POOL_PAGES_DATA', '423'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '15193'),
('INNODB_BUFFER_POOL_READS', '424'),
...
('INNODB_DATA_READ', '11227136'),
('INNODB_DATA_READS', '562'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'N:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'N:\\usr\\local\\mysql-5.5\\data\\Drakon.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'N:\\usr\\local\\mysql-5.5\\data\\Drakon.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'N:\\usr\\local\\mysql-5.5\\data\\Drakon.err'),
...
('PLUGIN_DIR', 'N:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'N:\\usr\\local\\mysql-5.5\\data\\Drakon-slow.log'),
...
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'data_authorizationadmin', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'data_comments', 'id_comment', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'data_comments_ibfk_12', 'def', 'dataadminapi', 'data_comments', 'id_story', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'data_comments_ibfk_17', 'def', 'dataadminapi', 'data_comments', 'id_user', 1, 1, 'dataadminapi', 'data_users', 'user_id'),
('def', 'dataadminapi', 'data_comments_ibfk_18', 'def', 'dataadminapi', 'data_comments', 'name_user', 1, 1, 'dataadminapi', 'data_users', 'user_name'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'data_comments_administrator', 'id_comment', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_2', 'def', 'dataadminapi', 'data_comments_administrator', 'id_story', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_6', 'def', 'dataadminapi', 'data_comments_administrator', 'id_admin', 1, 1, 'dataadminapi', 'data_authorizationadmin', 'id'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_7', 'def', 'dataadminapi', 'data_comments_administrator', 'name_admin', 1, 1, 'dataadminapi', 'data_authorizationadmin', 'name'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'data_stories', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'data_users', 'user_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_akira_story', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_akira_story', 'tag_id', 2, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'tags_akira_story_ibfk_1', 'def', 'dataadminapi', 'tags_akira_story', 'story_id', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_one_pice_story', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_one_pice_story', 'tag_id', 2, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'tags_one_pice_story_ibfk_1', 'def', 'dataadminapi', 'tags_one_pice_story', 'story_id', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_overlord_story', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_overlord_story', 'tag_id', 2, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'tags_overlord_story_ibfk_1', 'def', 'dataadminapi', 'tags_overlord_story', 'story_id', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'tag_id', 2, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story_ibfk_1', 'def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'story_id', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'story_id', 1, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'PRIMARY', 'def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'tag_id', 2, NULL, NULL, NULL, NULL),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story_ibfk_1', 'def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'story_id', 1, 1, 'dataadminapi', 'data_stories', 'story_id'),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-08-11 09:33:27', '2019-08-11 09:33:27', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-08-11 09:33:27', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'data_authorizationadmin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 0, '2019-02-05 07:56:44', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'data_comments', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 98304, 0, '2019-02-17 11:15:12', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'data_comments_administrator', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 65536, 0, '2019-02-21 09:42:28', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'data_stories', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2019-02-07 10:43:36', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'data_users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 0, '2019-02-17 13:36:46', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'tags_akira_story', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2019-07-25 11:39:26', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'tags_one_pice_story', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2019-07-25 15:54:44', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'tags_overlord_story', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2019-07-25 11:22:07', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 0, 0, '2019-07-20 10:56:39', NULL, NULL, NULL, '', '', NULL),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2019-07-25 11:45:44', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2019-08-11 09:18:56', '2012-05-15 12:23:07', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-05-15 12:23:05', '2019-08-08 14:29:54', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2019-07-20 09:40:54', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 540, 540, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-08-06 17:35:46', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 281474976710655, 9216, 60, '2012-06-11 22:55:25', '2019-07-15 13:56:19', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 104, 312, 281474976710655, 7168, 0, '2012-06-11 22:55:25', '2019-07-05 18:30:00', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-02-05 07:37:55', NULL, NULL, '', '', NULL);
...
(24, 'root', 'localhost:49844', 'dataadminapi', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(23, 'root', 'localhost:49843', NULL, 'Sleep', 3, '', NULL);
...
('def', 'dataadminapi', 'data_comments_ibfk_12', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'data_comments', 'data_stories'),
('def', 'dataadminapi', 'data_comments_ibfk_17', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'NO ACTION', 'data_comments', 'data_users'),
('def', 'dataadminapi', 'data_comments_ibfk_18', 'def', 'dataadminapi', 'user_name', 'NONE', 'CASCADE', 'NO ACTION', 'data_comments', 'data_users'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_2', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'data_comments_administrator', 'data_stories'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_6', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'NO ACTION', 'data_comments_administrator', 'data_authorizationadmin'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_7', 'def', 'dataadminapi', 'name', 'NONE', 'CASCADE', 'NO ACTION', 'data_comments_administrator', 'data_authorizationadmin'),
('def', 'dataadminapi', 'tags_akira_story_ibfk_1', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tags_akira_story', 'data_stories'),
('def', 'dataadminapi', 'tags_one_pice_story_ibfk_1', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tags_one_pice_story', 'data_stories'),
('def', 'dataadminapi', 'tags_overlord_story_ibfk_1', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tags_overlord_story', 'data_stories'),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story_ibfk_1', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tags_tihookeanskiyrubeg_story', 'data_stories'),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story_ibfk_1', 'def', 'dataadminapi', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'tags_tokiyskiyguli_story', 'data_stories');
...
('def', 'dataadminapi', 'utf8', 'utf8_bin', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '15655'),
('INNODB_BUFFER_POOL_READS', '424'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '1'),
('INNODB_DATA_FSYNCS', '7'),
...
('def', 'dataadminapi', 'data_authorizationadmin', 0, 'dataadminapi', 'PRIMARY', 1, 'id', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 1, 'dataadminapi', 'name', 1, 'name', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 0, 'dataadminapi', 'PRIMARY', 1, 'id_comment', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'name_user', 1, 'name_user', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'name_user_2', 1, 'name_user', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'name_user_3', 1, 'name_user', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'id_user', 1, 'id_user', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'id_story', 1, 'id_story', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments', 1, 'dataadminapi', 'id_story_2', 1, 'id_story', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 0, 'dataadminapi', 'PRIMARY', 1, 'id_comment', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 1, 'dataadminapi', 'id_admin', 1, 'id_admin', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 1, 'dataadminapi', 'id_admin_2', 1, 'id_admin', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 1, 'dataadminapi', 'id_story', 1, 'id_story', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 1, 'dataadminapi', 'name_admin', 1, 'name_admin', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_stories', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_users', 0, 'dataadminapi', 'PRIMARY', 1, 'user_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'data_users', 1, 'dataadminapi', 'user_name', 1, 'user_name', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_akira_story', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_akira_story', 0, 'dataadminapi', 'PRIMARY', 2, 'tag_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_one_pice_story', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_one_pice_story', 0, 'dataadminapi', 'PRIMARY', 2, 'tag_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_overlord_story', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_overlord_story', 0, 'dataadminapi', 'PRIMARY', 2, 'tag_id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 0, 'dataadminapi', 'PRIMARY', 2, 'tag_id', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', 0, 'dataadminapi', 'PRIMARY', 1, 'story_id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', 0, 'dataadminapi', 'PRIMARY', 2, 'tag_id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-08-11 09:33:29', '2019-08-11 09:33:29', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-08-11 09:33:29', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'dataadminapi', 'data_authorizationadmin', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 5242880, NULL, '2019-02-05 07:56:44', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'data_comments', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 98304, 5242880, 3, '2019-02-17 11:15:12', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dataadminapi', 'data_comments_administrator', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 65536, 5242880, 4, '2019-02-21 09:42:28', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dataadminapi', 'data_stories', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 5242880, NULL, '2019-02-07 10:43:36', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'data_users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 5242880, 4, '2019-02-17 13:36:46', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'dataadminapi', 'tags_akira_story', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, NULL, '2019-07-25 11:39:26', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'tags_one_pice_story', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, NULL, '2019-07-25 15:54:44', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'tags_overlord_story', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 5242880, NULL, '2019-07-25 11:22:07', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 0, 5242880, NULL, '2019-07-20 10:56:39', NULL, NULL, 'utf8_bin', NULL, '', ''),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 5242880, NULL, '2019-07-25 11:45:44', NULL, NULL, 'utf8_bin', NULL, '', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2019-08-11 09:18:56', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:05', '2019-08-08 14:29:54', NULL, 'utf8_general_ci', NULL, '', 'Events'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2019-07-20 09:40:54', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 540, 540, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-08-06 17:35:46', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 60, 281474976710655, 9216, 60, NULL, '2012-06-11 22:55:25', '2019-07-15 13:56:19', NULL, 'utf8_bin', NULL, '', 'Relation table'),
...
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 104, 312, 281474976710655, 7168, 0, NULL, '2012-06-11 22:55:25', '2019-07-05 18:30:00', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-02-05 07:37:55', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'data_authorizationadmin', 'PRIMARY KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'data_comments', 'PRIMARY KEY'),
('def', 'dataadminapi', 'data_comments_ibfk_12', 'dataadminapi', 'data_comments', 'FOREIGN KEY'),
('def', 'dataadminapi', 'data_comments_ibfk_17', 'dataadminapi', 'data_comments', 'FOREIGN KEY'),
('def', 'dataadminapi', 'data_comments_ibfk_18', 'dataadminapi', 'data_comments', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'data_comments_administrator', 'PRIMARY KEY'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_2', 'dataadminapi', 'data_comments_administrator', 'FOREIGN KEY'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_6', 'dataadminapi', 'data_comments_administrator', 'FOREIGN KEY'),
('def', 'dataadminapi', 'data_comments_administrator_ibfk_7', 'dataadminapi', 'data_comments_administrator', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'data_stories', 'PRIMARY KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'data_users', 'PRIMARY KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'tags_akira_story', 'PRIMARY KEY'),
('def', 'dataadminapi', 'tags_akira_story_ibfk_1', 'dataadminapi', 'tags_akira_story', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'tags_one_pice_story', 'PRIMARY KEY'),
('def', 'dataadminapi', 'tags_one_pice_story_ibfk_1', 'dataadminapi', 'tags_one_pice_story', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'tags_overlord_story', 'PRIMARY KEY'),
('def', 'dataadminapi', 'tags_overlord_story_ibfk_1', 'dataadminapi', 'tags_overlord_story', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'PRIMARY KEY'),
('def', 'dataadminapi', 'tags_tihookeanskiyrubeg_story_ibfk_1', 'dataadminapi', 'tags_tihookeanskiyrubeg_story', 'FOREIGN KEY'),
('def', 'dataadminapi', 'PRIMARY', 'dataadminapi', 'tags_tokiyskiyguli_story', 'PRIMARY KEY'),
('def', 'dataadminapi', 'tags_tokiyskiyguli_story_ibfk_1', 'dataadminapi', 'tags_tokiyskiyguli_story', 'FOREIGN KEY'),
...
('root', '[{"db":"dataadminapi","table":"tags_overlord_story"},{"db":"dataadminapi","table":"tags_tihookeanskiyrubeg_story"},{"db":"dataadminapi","table":"data_stories"},{"db":"dataadminapi","table":"data_authorizationadmin"},{"db":"dataadminapi","table":"data_comments"},{"db":"dataadminapi","table":"tags_tokiyskiyguli_story"},{"db":"dataadminapi","table":"tags_akira_story"},{"db":"dataadminapi","table":"tags_one_pice_story"},{"db":"dataadminapi","table":"tags_one pice_story"},{"db":"dataadminapi","table":"tags_newstory"}]');
...
('root', 'dataadminapi', 'data_comments', '{"sorted_col":"`data_comments`.`id_comment` ASC"}', '2019-02-17 13:38:38'),
('root', 'dataadminapi', 'data_comments_administrator', '{"sorted_col":"`data_comments_administrator`.`id_comment` ASC"}', '2019-07-05 18:30:00'),
('root', 'dataadminapi', 'data_users', '{"sorted_col":"`data_users`.`user_name` ASC"}', '2019-06-20 19:55:59');
...
('root', '2019-02-05 07:35:54', '{"lang":"ru"}');
